...
interface FeaturedSlideSectionProps {
...
export default function FeaturedSlideSection({
  categoryButton,
  title,
  trendTag = false,
  slides,
  ...
  return (
    <section className="py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* Slides Grid - Tất cả cards cùng kích thước, grid 3 columns */}
