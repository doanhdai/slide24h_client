...
export default function SlideDetailPage() {
  ...
  // Find slide by id - check /slide/, /product/, /animations/, and /ai-accounts/ hrefs
  const slide = allSlides.find(s => {
    const hrefId = s.href.replace('/slide/', '').replace('/product/', '').replace('/animations/', '').replace('/ai-accounts/', '');
